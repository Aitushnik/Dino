...
screen_size_display = (width_screen, height_screen) = (1540, 800)
FPS = 60
gravity = 0.6

black_color = (0,0,0)
white_color = (255,255,255)
bg_color = (117, 183, 253)
...
class Dino():
    def __init__(self, sx=-1, sy=-1):
        self.imgs, self.rect = load_sprite_sheet('dino.png', 5, 1, 88, 94, -1)
        self.imgs1, self.rect1 = load_sprite_sheet('dino_ducking.png', 2, 1, 118 , 94, -1)
...
class Cactus(pygame.sprite.Sprite):
    def __init__(self, speed=5, sx=-1, sy=-1):
        ...
        self.imgs, self.rect = load_sprite_sheet('cactus-small.png', 3, 1, 88, 94, -1)
        self.imgs, self.rect = load_sprite_sheet('cactus-big.png', 3, 1, 88, 94, -1)
        self.rect.bottom = int(0.98 * height_screen)
...
class birds(pygame.sprite.Sprite):
    def __init__(self, speed=5, sx=-1, sy=-1):
        pygame.sprite.Sprite.__init__(self,self.containers)
        self.imgs, self.rect = load_sprite_sheet('birds.png', 2, 1, 88, 94, -1)
...
class Cloud(pygame.sprite.Sprite):
    def __init__(self,x,y):
        pygame.sprite.Sprite.__init__(self,self.containers)
        self.image,self.rect = load_image('cloud.png',80,50,-1)
        self.speed = 1
        self.rect.left = x
        self.rect.top = y
...
def introduction_screen():
    ...
    t_ground,t_ground_rect = load_sprite_sheet('ground.png',15,1,15,20,-1)
    t_ground_rect.left = width_screen / 20
    t_ground_rect.bottom = height_screen

    logo,l_rect = load_image('logo.png',600,200,-1)
...
def gameplay():
    ...
    rbtn_image,rbtn_rect = load_image('replay_button.png',80,80,-1)
    gmo_image,gmo_rect = load_image('game_over.png',300,40,-1)
